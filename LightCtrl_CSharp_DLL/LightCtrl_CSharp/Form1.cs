...
namespace LightCtrl_CSharp
{
    ...
    public partial class LightCtrl : Form
    {
        ...
        public extern static int PortOpen(int portNum);
        [DllImport(@"LightControl.dll")]
        public static extern void PortClose();
        [DllImport(@"LightControl.dll")]
        public static extern void SendLightMessage(int nLightChannel, int LightEventFlag, int nLightOnOff, int nLightLevel);
        [DllImport(@"LightControl.dll")]
        public extern static void LightAutoTest(int nLightAutoTestChannel, int nLightAutoTestSpeed, int nLightAuoTestCount);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            /*DLL  함수*/
            nConnected_flag = PortOpen(portNum);
            CheckConnected();
        ...
        private void hScrollBar_Ch1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            SendLightMessage(nLightChannel, nLightEventFlag, nLightOnOff, nLightLevel[nLightChannel - 1]);
        ...
        private void Btn_AutoTest_Click(object sender, EventArgs e)
        {
            ...
            if (this.Btn_OnOFF.Text.Equals("ON"))
            {
                ...
                LightAutoTest(nAutoTestChannel, nSleepTime, nAutoTestCount);

                SendLightMessage(nAutoTestChannel, nLightEventFlag, nLightOnOff, nLightLevel[nAutoTestChannel - 1]);
            }
            else
            {
        ...
        private void Btn_DisConnect_Click(object sender, EventArgs e)
        {
            if (nConnected_flag == 1)
            {
                ...
                for (int nCnt = 0; nCnt < nMaxChannel; nCnt++)
                {
                    ...
                    nLightLevel[nCnt] = 0;
                    SendLightMessage(nLightChannel, nLightEventFlag, nLightOnOff, nLightLevel[nCnt]);
